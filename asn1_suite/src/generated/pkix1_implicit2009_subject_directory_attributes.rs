...
#[derive(Debug, Clone)]
pub struct PKIX1Implicit2009SubjectDirectoryAttributes(pub Vec<AttributeSet>);

impl Deref for PKIX1Implicit2009SubjectDirectoryAttributes {
    type Target = Vec<AttributeSet>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Implicit2009SubjectDirectoryAttributes {
...
impl DERSerializable for PKIX1Implicit2009SubjectDirectoryAttributes {
