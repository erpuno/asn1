...
#[derive(Debug, Clone)]
pub struct KEPDigestAlgorithmIdentifiers(pub Vec<KEPDigestAlgorithmIdentifier>);

impl Deref for KEPDigestAlgorithmIdentifiers {
    type Target = Vec<KEPDigestAlgorithmIdentifier>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for KEPDigestAlgorithmIdentifiers {
...
impl DERSerializable for KEPDigestAlgorithmIdentifiers {
