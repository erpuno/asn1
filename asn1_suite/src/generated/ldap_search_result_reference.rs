...
#[derive(Debug, Clone)]
pub struct LDAPSearchResultReference(pub Vec<LDAPURI>);

impl Deref for LDAPSearchResultReference {
    type Target = Vec<LDAPURI>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for LDAPSearchResultReference {
...
impl DERSerializable for LDAPSearchResultReference {
