...
#[derive(Debug, Clone)]
pub struct KEPGeneralNames(pub Vec<KEPGeneralName>);

impl Deref for KEPGeneralNames {
    type Target = Vec<KEPGeneralName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for KEPGeneralNames {
...
impl DERSerializable for KEPGeneralNames {
