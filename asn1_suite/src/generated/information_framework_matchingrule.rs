...
#[derive(Clone, Debug)]
pub struct InformationFrameworkMATCHINGRULE {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for InformationFrameworkMATCHINGRULE {
...
impl DERSerializable for InformationFrameworkMATCHINGRULE {
