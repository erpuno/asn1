...
#[derive(Debug, Clone)]
pub struct DSTUExtensions(pub Vec<DSTUExtension>);

impl Deref for DSTUExtensions {
    type Target = Vec<DSTUExtension>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for DSTUExtensions {
...
impl DERSerializable for DSTUExtensions {
