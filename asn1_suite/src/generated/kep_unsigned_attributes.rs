...
#[derive(Debug, Clone)]
pub struct KEPUnsignedAttributes(pub Vec<KEPAttribute>);

impl Deref for KEPUnsignedAttributes {
    type Target = Vec<KEPAttribute>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for KEPUnsignedAttributes {
...
impl DERSerializable for KEPUnsignedAttributes {
