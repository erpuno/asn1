...
#[derive(Debug, Clone)]
pub struct CertificateExtensionsPolicyMappingsSyntax(pub Vec<CertificateExtensionsPolicyMappingsSyntaxElement>);

impl Deref for CertificateExtensionsPolicyMappingsSyntax {
    type Target = Vec<CertificateExtensionsPolicyMappingsSyntaxElement>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CertificateExtensionsPolicyMappingsSyntax {
...
impl DERSerializable for CertificateExtensionsPolicyMappingsSyntax {
