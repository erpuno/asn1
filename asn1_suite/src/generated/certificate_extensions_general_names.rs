...
#[derive(Debug, Clone)]
pub struct CertificateExtensionsGeneralNames(pub Vec<CertificateExtensionsGeneralName>);

impl Deref for CertificateExtensionsGeneralNames {
    type Target = Vec<CertificateExtensionsGeneralName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CertificateExtensionsGeneralNames {
...
impl DERSerializable for CertificateExtensionsGeneralNames {
