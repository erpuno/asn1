...
#[derive(Debug, Clone)]
pub struct AuthenticationFrameworkCrossCertificates(pub Vec<AuthenticationFrameworkCertificate>);

impl Deref for AuthenticationFrameworkCrossCertificates {
    type Target = Vec<AuthenticationFrameworkCertificate>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for AuthenticationFrameworkCrossCertificates {
...
impl DERSerializable for AuthenticationFrameworkCrossCertificates {
