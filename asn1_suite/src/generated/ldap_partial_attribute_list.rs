...
#[derive(Debug, Clone)]
pub struct LDAPPartialAttributeList(pub Vec<LDAPPartialAttribute>);

impl Deref for LDAPPartialAttributeList {
    type Target = Vec<LDAPPartialAttribute>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for LDAPPartialAttributeList {
...
impl DERSerializable for LDAPPartialAttributeList {
