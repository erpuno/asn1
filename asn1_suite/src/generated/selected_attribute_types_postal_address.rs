...
#[derive(Debug, Clone)]
pub struct SelectedAttributeTypesPostalAddress(pub Vec<SelectedAttributeTypesDirectoryString>);

impl Deref for SelectedAttributeTypesPostalAddress {
...
impl DERParseable for SelectedAttributeTypesPostalAddress {
...
impl DERSerializable for SelectedAttributeTypesPostalAddress {
