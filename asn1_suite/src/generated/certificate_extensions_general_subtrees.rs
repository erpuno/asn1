...
#[derive(Debug, Clone)]
pub struct CertificateExtensionsGeneralSubtrees(pub Vec<CertificateExtensionsGeneralSubtree>);

impl Deref for CertificateExtensionsGeneralSubtrees {
    type Target = Vec<CertificateExtensionsGeneralSubtree>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CertificateExtensionsGeneralSubtrees {
...
impl DERSerializable for CertificateExtensionsGeneralSubtrees {
