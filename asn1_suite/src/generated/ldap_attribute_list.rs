...
#[derive(Debug, Clone)]
pub struct LDAPAttributeList(pub Vec<LDAPAttribute>);

impl Deref for LDAPAttributeList {
...
impl DERParseable for LDAPAttributeList {
...
impl DERSerializable for LDAPAttributeList {
