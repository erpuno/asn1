...
#[derive(Clone, Debug)]
pub struct InformationFrameworkMATCHINGRESTRICTION {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for InformationFrameworkMATCHINGRESTRICTION {
...
impl DERSerializable for InformationFrameworkMATCHINGRESTRICTION {
