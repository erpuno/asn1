...
#[derive(Debug, Clone)]
pub struct SelectedAttributeTypesCaseIgnoreListMatch(pub Vec<SelectedAttributeTypesDirectoryString>);

impl Deref for SelectedAttributeTypesCaseIgnoreListMatch {
    type Target = Vec<SelectedAttributeTypesDirectoryString>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for SelectedAttributeTypesCaseIgnoreListMatch {
...
impl DERSerializable for SelectedAttributeTypesCaseIgnoreListMatch {
