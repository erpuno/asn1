...
#[derive(Debug, Clone)]
pub struct InformationFrameworkRDNSequence(pub Vec<InformationFrameworkRelativeDistinguishedName>);

impl Deref for InformationFrameworkRDNSequence {
    type Target = Vec<InformationFrameworkRelativeDistinguishedName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for InformationFrameworkRDNSequence {
...
impl DERSerializable for InformationFrameworkRDNSequence {
