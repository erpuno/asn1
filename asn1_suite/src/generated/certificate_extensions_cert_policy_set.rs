...
#[derive(Debug, Clone)]
pub struct CertificateExtensionsCertPolicySet(pub Vec<CertificateExtensionsCertPolicyId>);

impl Deref for CertificateExtensionsCertPolicySet {
    type Target = Vec<CertificateExtensionsCertPolicyId>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CertificateExtensionsCertPolicySet {
...
impl DERSerializable for CertificateExtensionsCertPolicySet {
