...
#[derive(Clone, Debug)]
pub struct AuthenticationFrameworkExtension {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AuthenticationFrameworkExtension {
...
impl DERSerializable for AuthenticationFrameworkExtension {
