...
#[derive(Debug, Clone)]
pub struct KEPSignedAttributes(pub Vec<KEPAttribute>);

impl Deref for KEPSignedAttributes {
...
impl DERParseable for KEPSignedAttributes {
...
impl DERSerializable for KEPSignedAttributes {
