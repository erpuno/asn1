...
#[derive(Debug, Clone)]
pub struct LDAPAttributeSelection(pub Vec<LDAPString>);

impl Deref for LDAPAttributeSelection {
    type Target = Vec<LDAPString>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for LDAPAttributeSelection {
...
impl DERSerializable for LDAPAttributeSelection {
