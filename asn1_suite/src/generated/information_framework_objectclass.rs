...
#[derive(Clone, Debug)]
pub struct InformationFrameworkOBJECTCLASS {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for InformationFrameworkOBJECTCLASS {
...
impl DERSerializable for InformationFrameworkOBJECTCLASS {
