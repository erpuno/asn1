...
#[derive(Debug, Clone)]
pub struct CertificateExtensionsCertificatePoliciesSyntax(pub Vec<CertificateExtensionsPolicyInformation>);

impl Deref for CertificateExtensionsCertificatePoliciesSyntax {
    type Target = Vec<CertificateExtensionsPolicyInformation>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CertificateExtensionsCertificatePoliciesSyntax {
...
impl DERSerializable for CertificateExtensionsCertificatePoliciesSyntax {
