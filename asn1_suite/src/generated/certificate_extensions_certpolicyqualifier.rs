...
#[derive(Clone, Debug)]
pub struct CertificateExtensionsCERTPOLICYQUALIFIER {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for CertificateExtensionsCERTPOLICYQUALIFIER {
...
impl DERSerializable for CertificateExtensionsCERTPOLICYQUALIFIER {
