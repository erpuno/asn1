...
#[derive(Debug, Clone)]
pub struct PKIXCMP2009POPODecKeyRespContent(pub Vec<ASN1Integer>);

impl Deref for PKIXCMP2009POPODecKeyRespContent {
    type Target = Vec<ASN1Integer>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIXCMP2009POPODecKeyRespContent {
...
impl DERSerializable for PKIXCMP2009POPODecKeyRespContent {
