...
#[derive(Debug, Clone)]
pub struct DSTURDNSequence(pub Vec<DSTURelativeDistinguishedName>);

impl Deref for DSTURDNSequence {
    type Target = Vec<DSTURelativeDistinguishedName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for DSTURDNSequence {
...
impl DERSerializable for DSTURDNSequence {
