...
#[derive(Debug, Clone)]
pub struct PKIXCMP2009PKIFreeText(pub Vec<ASN1UTF8String>);

impl Deref for PKIXCMP2009PKIFreeText {
    type Target = Vec<ASN1UTF8String>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIXCMP2009PKIFreeText {
...
impl DERSerializable for PKIXCMP2009PKIFreeText {
