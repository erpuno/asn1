...
#[derive(Debug, Clone)]
pub struct LDAPControls(pub Vec<LDAPControl>);

impl Deref for LDAPControls {
    type Target = Vec<LDAPControl>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for LDAPControls {
...
impl DERSerializable for LDAPControls {
