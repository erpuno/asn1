...
#[derive(Debug, Clone)]
pub struct InformationFrameworkRelativeDistinguishedName(pub Vec<InformationFrameworkAttributeTypeAndValue>);

impl Deref for InformationFrameworkRelativeDistinguishedName {
    type Target = Vec<InformationFrameworkAttributeTypeAndValue>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for InformationFrameworkRelativeDistinguishedName {
...
impl DERSerializable for InformationFrameworkRelativeDistinguishedName {
