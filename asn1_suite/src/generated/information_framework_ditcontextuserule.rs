...
#[derive(Clone, Debug)]
pub struct InformationFrameworkDITCONTEXTUSERULE {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for InformationFrameworkDITCONTEXTUSERULE {
...
impl DERSerializable for InformationFrameworkDITCONTEXTUSERULE {
