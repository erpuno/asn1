...
#[derive(Debug, Clone)]
pub struct KEPSignerInfos(pub Vec<KEPSignerInfo>);

impl Deref for KEPSignerInfos {
    type Target = Vec<KEPSignerInfo>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for KEPSignerInfos {
...
impl DERSerializable for KEPSignerInfos {
