...
#[derive(Debug, Clone)]
pub struct KEPPKIFreeText(pub Vec<ASN1UTF8String>);

impl Deref for KEPPKIFreeText {
...
impl DERParseable for KEPPKIFreeText {
...
impl DERSerializable for KEPPKIFreeText {
