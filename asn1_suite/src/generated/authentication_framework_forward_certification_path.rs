...
#[derive(Debug, Clone)]
pub struct AuthenticationFrameworkForwardCertificationPath(pub Vec<AuthenticationFrameworkCrossCertificates>);

impl Deref for AuthenticationFrameworkForwardCertificationPath {
    type Target = Vec<AuthenticationFrameworkCrossCertificates>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for AuthenticationFrameworkForwardCertificationPath {
...
impl DERSerializable for AuthenticationFrameworkForwardCertificationPath {
