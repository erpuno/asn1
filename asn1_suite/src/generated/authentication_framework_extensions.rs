...
#[derive(Debug, Clone)]
pub struct AuthenticationFrameworkExtensions(pub Vec<AuthenticationFrameworkExtension>);

impl Deref for AuthenticationFrameworkExtensions {
    type Target = Vec<AuthenticationFrameworkExtension>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for AuthenticationFrameworkExtensions {
...
impl DERSerializable for AuthenticationFrameworkExtensions {
