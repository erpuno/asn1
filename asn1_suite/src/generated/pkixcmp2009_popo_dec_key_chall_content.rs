...
#[derive(Debug, Clone)]
pub struct PKIXCMP2009POPODecKeyChallContent(pub Vec<PKIXCMP2009Challenge>);

impl Deref for PKIXCMP2009POPODecKeyChallContent {
    type Target = Vec<PKIXCMP2009Challenge>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIXCMP2009POPODecKeyChallContent {
...
impl DERSerializable for PKIXCMP2009POPODecKeyChallContent {
