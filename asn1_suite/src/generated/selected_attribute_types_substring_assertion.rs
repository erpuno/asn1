...
#[derive(Debug, Clone)]
pub struct SelectedAttributeTypesSubstringAssertion(pub Vec<SelectedAttributeTypesSubstringAssertionElement>);

impl Deref for SelectedAttributeTypesSubstringAssertion {
    type Target = Vec<SelectedAttributeTypesSubstringAssertionElement>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for SelectedAttributeTypesSubstringAssertion {
...
impl DERSerializable for SelectedAttributeTypesSubstringAssertion {
