...
#[derive(Debug, Clone)]
pub struct SelectedAttributeTypesZonalSelect(pub Vec<PKIX1Explicit2009AttributeType>);

impl Deref for SelectedAttributeTypesZonalSelect {
    type Target = Vec<PKIX1Explicit2009AttributeType>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for SelectedAttributeTypesZonalSelect {
...
impl DERSerializable for SelectedAttributeTypesZonalSelect {
