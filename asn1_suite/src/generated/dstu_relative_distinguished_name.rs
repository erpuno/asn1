...
#[derive(Debug, Clone)]
pub struct DSTURelativeDistinguishedName(pub Vec<DSTUAttributeTypeAndValue>);

impl Deref for DSTURelativeDistinguishedName {
    type Target = Vec<DSTUAttributeTypeAndValue>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for DSTURelativeDistinguishedName {
...
impl DERSerializable for DSTURelativeDistinguishedName {
