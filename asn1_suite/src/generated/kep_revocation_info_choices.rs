...
#[derive(Debug, Clone)]
pub struct KEPRevocationInfoChoices(pub Vec<KEPCertificateList>);

impl Deref for KEPRevocationInfoChoices {
    type Target = Vec<KEPCertificateList>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for KEPRevocationInfoChoices {
...
impl DERSerializable for KEPRevocationInfoChoices {
