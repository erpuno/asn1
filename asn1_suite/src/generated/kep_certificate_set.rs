...
#[derive(Debug, Clone)]
pub struct KEPCertificateSet(pub Vec<DSTUCertificate>);

impl Deref for KEPCertificateSet {
    type Target = Vec<DSTUCertificate>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for KEPCertificateSet {
...
impl DERSerializable for KEPCertificateSet {
