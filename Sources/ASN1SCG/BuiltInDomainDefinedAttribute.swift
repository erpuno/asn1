...
@usableFromInline struct BuiltInDomainDefinedAttribute: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return BuiltInDomainDefinedAttribute(type: type, value: value)
        }
    }
