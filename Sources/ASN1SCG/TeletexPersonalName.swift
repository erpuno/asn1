...
@usableFromInline struct TeletexPersonalName: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.set(root, identifier: identifier) { nodes in
            ...
            return TeletexPersonalName(surname: surname, given_name: given_name, initials: initials, generation_qualifier: generation_qualifier)
        }
    }
