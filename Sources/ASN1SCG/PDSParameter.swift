...
@usableFromInline struct PDSParameter: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.set(root, identifier: identifier) { nodes in
            ...
            return PDSParameter(printable_string: printable_string, teletex_string: teletex_string)
        }
    }
