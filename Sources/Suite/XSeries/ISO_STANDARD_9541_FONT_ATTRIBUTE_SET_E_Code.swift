...
public struct ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_E_Code : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_E_Code, rhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_E_Code) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let letter_space = Self(rawValue: 1)
    public static let word_space = Self(rawValue: 2)
    public static let no_adjust = Self(rawValue: 3)
}
