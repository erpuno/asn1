...
@usableFromInline indirect enum CertificateExtensions_DistributionPointName: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    @inlinable static var defaultIdentifier: ASN1Identifier { .enumerated }
        case fullName(CertificateExtensions_GeneralNames)
    case nameRelativeToCRLIssuer(PKIX1Explicit88_RelativeDistinguishedName)
    @inlinable init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        switch rootNode.identifier {
            case ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific):
                self = .fullName(try CertificateExtensions_GeneralNames(derEncoded: rootNode, withIdentifier: rootNode.identifier))
