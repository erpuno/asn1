...
@usableFromInline struct EnrollmentMessageSyntax_2009_BodyPartList: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @inlinable public init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self.value = try DER.sequence(of: EnrollmentMessageSyntax_2009_BodyPartID.self, identifier: identifier, rootNode: rootNode)
    }
