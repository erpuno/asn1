...
public struct Character_Presentation_Attributes_Pairwise_Kerning : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Character_Presentation_Attributes_Pairwise_Kerning, rhs: Character_Presentation_Attributes_Pairwise_Kerning) -> Bool { lhs.rawValue < rhs.rawValue }
