...
public struct ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Cardinal : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Cardinal, rhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Cardinal) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let last = Self(rawValue: 4294967295)
}
