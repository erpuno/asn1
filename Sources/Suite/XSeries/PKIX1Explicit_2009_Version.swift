...
public struct PKIX1Explicit_2009_Version : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: PKIX1Explicit_2009_Version, rhs: PKIX1Explicit_2009_Version) -> Bool { lhs.rawValue < rhs.rawValue }
