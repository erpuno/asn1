...
public struct Temporal_Relationships_Synchronization_Type : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    ...
    public static let parallel_last = Self(rawValue: 0)
    public static let parallel_first = Self(rawValue: 1)
    public static let parallel_selective = Self(rawValue: 2)
    public static let sequential = Self(rawValue: 3)
}
