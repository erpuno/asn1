...
public struct Layout_Descriptors_Position_Spec_alignment_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Layout_Descriptors_Position_Spec_alignment_IntEnum, rhs: Layout_Descriptors_Position_Spec_alignment_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let centred = Self(rawValue: 1)
    public static let left_hand = Self(rawValue: 2)
}
