...
@usableFromInline struct Link_Descriptors_Link_Descriptor: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable func serialize(into coder: inout DER.Serializer,
        ...
        try coder.appendConstructedNode(identifier: identifier) { coder in
            ...
            if let link_class = self.link_class { try coder.serializeOptionalImplicitlyTagged(link_class, withIdentifier: ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific)) }
