...
public struct Geo_Gr_Presentation_Attributes_SpecificationMode: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let absolute = Self(rawValue: 0)
    static let scaled = Self(rawValue: 1)
}
