...
public struct Character_Presentation_Attributes_Alignment : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Character_Presentation_Attributes_Alignment, rhs: Character_Presentation_Attributes_Alignment) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let justified = Self(rawValue: 3)
}
