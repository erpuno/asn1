...
@usableFromInline struct PKIXAttributeCertificate_2009_RoleSyntax: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable func serialize(into coder: inout DER.Serializer,
        ...
        try coder.appendConstructedNode(identifier: identifier) { coder in
            if let roleAuthority = self.roleAuthority { try coder.serializeOptionalImplicitlyTagged(roleAuthority, withIdentifier: ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific)) }
