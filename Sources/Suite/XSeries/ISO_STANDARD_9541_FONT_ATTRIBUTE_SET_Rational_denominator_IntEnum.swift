...
public struct ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Rational_denominator_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Rational_denominator_IntEnum, rhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Rational_denominator_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let last = Self(rawValue: 2147483647)
}
