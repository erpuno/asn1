...
public struct DirectoryAbstractService_ServiceControls_scopeOfReferral_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: DirectoryAbstractService_ServiceControls_scopeOfReferral_IntEnum, rhs: DirectoryAbstractService_ServiceControls_scopeOfReferral_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let dmd = Self(rawValue: 0)
    public static let country = Self(rawValue: 1)
}
