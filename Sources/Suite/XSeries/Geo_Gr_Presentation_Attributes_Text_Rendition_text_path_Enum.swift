...
public struct Geo_Gr_Presentation_Attributes_Text_Rendition_text_path_Enum: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let right = Self(rawValue: 0)
    static let left = Self(rawValue: 1)
    static let up = Self(rawValue: 2)
    static let down = Self(rawValue: 3)
}
