...
public struct Geo_Gr_Presentation_Attributes_ASF_Type: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let bundled = Self(rawValue: 0)
    static let individual = Self(rawValue: 1)
}
