...
@usableFromInline struct SMIMESymmetricKeyDistribution_2009_GLNewKeyAttributes: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return SMIMESymmetricKeyDistribution_2009_GLNewKeyAttributes(rekeyControlledByGLO: rekeyControlledByGLO, recipientsNotMutuallyAware: recipientsNotMutuallyAware, duration: duration, generationCounter: generationCounter, requestedAlgorithm: requestedAlgorithm)
        }
    }
