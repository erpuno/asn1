...
@usableFromInline struct Raster_Gr_Coding_Attributes: DERImplicitlyTaggable, Sendable {
    ...
    @usableFromInline var interleaving_format: Raster_Gr_Coding_Attributes_interleaving_format_IntEnum?
    ...
    @usableFromInline var jpeg_coding_mode: Raster_Gr_Coding_Attributes_jpeg_coding_mode_IntEnum
    @usableFromInline var jpeg_quantization_table: Raster_Gr_Coding_Attributes_jpeg_quantization_table_IntEnum?
    @usableFromInline var jpeg_huffman_table: Raster_Gr_Coding_Attributes_jpeg_huffman_table_IntEnum
    @usableFromInline var jbig_differential_layer: Raster_Gr_Coding_Attributes_jbig_differential_layer_IntEnum?
    @usableFromInline var number_of_lines_per_stripe: ArraySlice<UInt8>?
    @inlinable init(number_of_pels_per_line: ArraySlice<UInt8>?, number_of_lines: ArraySlice<UInt8>?, compression: Raster_Gr_Coding_Attributes_Compression?, number_of_discarded_pels: ArraySlice<UInt8>?, bits_per_colour_component: Raster_Gr_Coding_Attributes_Bits_Per_Colour_Component?, interleaving_format: Raster_Gr_Coding_Attributes_interleaving_format_IntEnum?, number_of_pels_per_tile_line: ArraySlice<UInt8>?, number_of_lines_per_tile: ArraySlice<UInt8>?, tiling_offset: Raster_Gr_Presentation_Attributes_Coordinate_Pair?, tile_types: [Raster_Gr_Coding_Attributes_Tile_Type]?, subsampling: Raster_Gr_Coding_Attributes_Subsampling?, jpeg_coding_mode: Raster_Gr_Coding_Attributes_jpeg_coding_mode_IntEnum, jpeg_quantization_table: Raster_Gr_Coding_Attributes_jpeg_quantization_table_IntEnum?, jpeg_huffman_table: Raster_Gr_Coding_Attributes_jpeg_huffman_table_IntEnum, jbig_differential_layer: Raster_Gr_Coding_Attributes_jbig_differential_layer_IntEnum?, number_of_lines_per_stripe: ArraySlice<UInt8>?) {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.set(root, identifier: identifier) { nodes in
            ...
            let interleaving_format = try Raster_Gr_Coding_Attributes_interleaving_format_IntEnum(rawValue: Int(derEncoded: &nodes))
            ...
            let jpeg_coding_mode = try Raster_Gr_Coding_Attributes_jpeg_coding_mode_IntEnum(rawValue: Int(derEncoded: &nodes))
            let jpeg_quantization_table = try Raster_Gr_Coding_Attributes_jpeg_quantization_table_IntEnum(rawValue: Int(derEncoded: &nodes))
            let jpeg_huffman_table = try Raster_Gr_Coding_Attributes_jpeg_huffman_table_IntEnum(rawValue: Int(derEncoded: &nodes))
            let jbig_differential_layer = try Raster_Gr_Coding_Attributes_jbig_differential_layer_IntEnum(rawValue: Int(derEncoded: &nodes))
            ...
            return Raster_Gr_Coding_Attributes(number_of_pels_per_line: number_of_pels_per_line, number_of_lines: number_of_lines, compression: compression, number_of_discarded_pels: number_of_discarded_pels, bits_per_colour_component: bits_per_colour_component, interleaving_format: interleaving_format, number_of_pels_per_tile_line: number_of_pels_per_tile_line, number_of_lines_per_tile: number_of_lines_per_tile, tiling_offset: tiling_offset, tile_types: tile_types, subsampling: subsampling, jpeg_coding_mode: jpeg_coding_mode, jpeg_quantization_table: jpeg_quantization_table, jpeg_huffman_table: jpeg_huffman_table, jbig_differential_layer: jbig_differential_layer, number_of_lines_per_stripe: number_of_lines_per_stripe)
        }
    }
    @inlinable func serialize(into coder: inout DER.Serializer,
        withIdentifier identifier: ASN1Identifier) throws {
        try coder.appendConstructedNode(identifier: identifier) { coder in
            if let number_of_pels_per_line = self.number_of_pels_per_line { try coder.serializeOptionalImplicitlyTagged(number_of_pels_per_line, withIdentifier: ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific)) }
            if let number_of_lines = self.number_of_lines { try coder.serializeOptionalImplicitlyTagged(number_of_lines, withIdentifier: ASN1Identifier(tagWithNumber: 1, tagClass: .contextSpecific)) }
            if let compression = self.compression { try coder.serializeOptionalImplicitlyTagged(compression, withIdentifier: ASN1Identifier(tagWithNumber: 2, tagClass: .contextSpecific)) }
            if let number_of_discarded_pels = self.number_of_discarded_pels { try coder.serializeOptionalImplicitlyTagged(number_of_discarded_pels, withIdentifier: ASN1Identifier(tagWithNumber: 3, tagClass: .contextSpecific)) }
            if let bits_per_colour_component = self.bits_per_colour_component { try coder.serialize(explicitlyTaggedWithTagNumber: 4, tagClass: .contextSpecific) { codec in try codec.serialize(bits_per_colour_component) } }
            ...
            if let number_of_pels_per_tile_line = self.number_of_pels_per_tile_line { try coder.serializeOptionalImplicitlyTagged(number_of_pels_per_tile_line, withIdentifier: ASN1Identifier(tagWithNumber: 6, tagClass: .contextSpecific)) }
            if let number_of_lines_per_tile = self.number_of_lines_per_tile { try coder.serializeOptionalImplicitlyTagged(number_of_lines_per_tile, withIdentifier: ASN1Identifier(tagWithNumber: 7, tagClass: .contextSpecific)) }
            if let tiling_offset = self.tiling_offset { try coder.serializeOptionalImplicitlyTagged(tiling_offset, withIdentifier: ASN1Identifier(tagWithNumber: 8, tagClass: .contextSpecific)) }
            if let tile_types = self.tile_types { try coder.serializeSequenceOf(tile_types, identifier: ASN1Identifier(tagWithNumber: 9, tagClass: .contextSpecific)) }
            if let subsampling = self.subsampling { try coder.serializeOptionalImplicitlyTagged(subsampling, withIdentifier: ASN1Identifier(tagWithNumber: 10, tagClass: .contextSpecific)) }
            ...
            if let number_of_lines_per_stripe = self.number_of_lines_per_stripe { try coder.serializeOptionalImplicitlyTagged(number_of_lines_per_stripe, withIdentifier: ASN1Identifier(tagWithNumber: 18, tagClass: .contextSpecific)) }
