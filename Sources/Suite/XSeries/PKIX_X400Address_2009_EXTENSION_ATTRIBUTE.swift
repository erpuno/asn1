...
@usableFromInline struct PKIX_X400Address_2009_EXTENSION_ATTRIBUTE: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return PKIX_X400Address_2009_EXTENSION_ATTRIBUTE(algorithm: algorithm, parameters: parameters)
        }
    }
