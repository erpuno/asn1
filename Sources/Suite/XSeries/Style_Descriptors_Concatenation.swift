...
public struct Style_Descriptors_Concatenation : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Style_Descriptors_Concatenation, rhs: Style_Descriptors_Concatenation) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let non_concatenated = Self(rawValue: 0)
    public static let concatenated = Self(rawValue: 1)
}
