...
@usableFromInline struct PKIX_X400Address_2009_PresentationAddress: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return PKIX_X400Address_2009_PresentationAddress(pSelector: pSelector, sSelector: sSelector, tSelector: tSelector, nAddresses: nAddresses)
        }
    }
