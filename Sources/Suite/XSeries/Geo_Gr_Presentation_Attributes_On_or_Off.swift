...
public struct Geo_Gr_Presentation_Attributes_On_or_Off: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let off = Self(rawValue: 0)
    static let on = Self(rawValue: 1)
}
