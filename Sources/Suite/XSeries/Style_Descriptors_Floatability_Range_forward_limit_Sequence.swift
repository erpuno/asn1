...
@usableFromInline struct Style_Descriptors_Floatability_Range_forward_limit_Sequence: DERImplicitlyTaggable, Hashable, Sendable {
    @inlinable static var defaultIdentifier: ASN1Identifier { .sequence }
    @usableFromInline var logical_object: Style_Descriptors_Floatability_Range_forward_limit_Sequence_logical_object_Choice
    @usableFromInline var layout_object: Style_Descriptors_Floatability_Range_forward_limit_Sequence_layout_object_Choice?
    @inlinable init(logical_object: Style_Descriptors_Floatability_Range_forward_limit_Sequence_logical_object_Choice, layout_object: Style_Descriptors_Floatability_Range_forward_limit_Sequence_layout_object_Choice?) {
