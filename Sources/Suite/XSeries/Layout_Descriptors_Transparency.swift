...
public struct Layout_Descriptors_Transparency : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Layout_Descriptors_Transparency, rhs: Layout_Descriptors_Transparency) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let opaque = Self(rawValue: 1)
}
