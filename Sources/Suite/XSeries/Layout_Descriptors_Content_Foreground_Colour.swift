...
@usableFromInline indirect enum Layout_Descriptors_Content_Foreground_Colour: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    @inlinable static var defaultIdentifier: ASN1Identifier { .enumerated }
        case implementation_defined(ASN1Null)
    case content_foreground_transparency(ASN1Null)
    ...
    @inlinable init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        switch rootNode.identifier {
            ...
            case ASN1Identifier(tagWithNumber: 2, tagClass: .contextSpecific):
                self = .content_foreground_transparency(try ASN1Null(derEncoded: rootNode, withIdentifier: rootNode.identifier))
