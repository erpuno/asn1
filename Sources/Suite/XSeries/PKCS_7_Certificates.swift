...
@usableFromInline struct PKCS_7_Certificates: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @inlinable public init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self.value = try DER.sequence(of: AuthenticationFramework_Certificate.self, identifier: identifier, rootNode: rootNode)
    }
