...
public struct ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Integer : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Integer, rhs: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Integer) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let first = Self(rawValue: -2147483648)
