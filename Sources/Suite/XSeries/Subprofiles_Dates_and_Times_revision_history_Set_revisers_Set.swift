...
@usableFromInline struct Subprofiles_Dates_and_Times_revision_history_Set_revisers_Set: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.set(root, identifier: identifier) { nodes in
            ...
            return Subprofiles_Dates_and_Times_revision_history_Set_revisers_Set(names: names, position: position, organization: organization)
        }
    }
