...
public struct Raster_Gr_Coding_Attributes_Raster_Gr_Coding_Attributes_jpeg_quantization_table_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Raster_Gr_Coding_Attributes_Raster_Gr_Coding_Attributes_jpeg_quantization_table_IntEnum, rhs: Raster_Gr_Coding_Attributes_Raster_Gr_Coding_Attributes_jpeg_quantization_table_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
