...
@usableFromInline struct EnrollmentMessageSyntax_2009_CertificationRequest_certificationRequestInfo_Sequence_subjectPublicKeyInfo_Sequence: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return EnrollmentMessageSyntax_2009_CertificationRequest_certificationRequestInfo_Sequence_subjectPublicKeyInfo_Sequence(algorithm: algorithm, subjectPublicKey: subjectPublicKey)
        }
    }
