...
@usableFromInline struct PKIXAttributeCertificate_2009_IetfAttrSyntax: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable func serialize(into coder: inout DER.Serializer,
        ...
        try coder.appendConstructedNode(identifier: identifier) { coder in
            if let policyAuthority = self.policyAuthority { try coder.serializeOptionalImplicitlyTagged(policyAuthority, withIdentifier: ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific)) }
