...
public struct Raster_Gr_Coding_Attributes_jpeg_huffman_table_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Raster_Gr_Coding_Attributes_jpeg_huffman_table_IntEnum, rhs: Raster_Gr_Coding_Attributes_jpeg_huffman_table_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
