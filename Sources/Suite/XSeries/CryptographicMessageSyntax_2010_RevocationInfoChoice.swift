...
@usableFromInline indirect enum CryptographicMessageSyntax_2010_RevocationInfoChoice: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @inlinable func serialize(into coder: inout DER.Serializer, withIdentifier identifier: ASN1Identifier) throws {
        switch self {
            case .crl(let crl): try coder.serialize(crl)
