...
@usableFromInline indirect enum Identifiers_and_Expressions_Atomic_String_Expression: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
