...
public struct DirectoryAbstractService_ProtectionRequest : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: DirectoryAbstractService_ProtectionRequest, rhs: DirectoryAbstractService_ProtectionRequest) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let signed = Self(rawValue: 1)
    public static let encrypted = Self(rawValue: 2)
    public static let signed_encrypted = Self(rawValue: 3)
}
