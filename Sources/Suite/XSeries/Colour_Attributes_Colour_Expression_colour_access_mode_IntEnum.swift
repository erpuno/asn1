...
public struct Colour_Attributes_Colour_Expression_colour_access_mode_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Colour_Attributes_Colour_Expression_colour_access_mode_IntEnum, rhs: Colour_Attributes_Colour_Expression_colour_access_mode_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let direct = Self(rawValue: 0)
    public static let indexed = Self(rawValue: 1)
}
