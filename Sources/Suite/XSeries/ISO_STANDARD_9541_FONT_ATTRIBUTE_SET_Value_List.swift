...
@usableFromInline struct ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Value_List: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @inlinable public init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self.value = try DER.set(of: ISO_STANDARD_9541_FONT_ATTRIBUTE_SET_Value.self, identifier: identifier, rootNode: rootNode)
    }
