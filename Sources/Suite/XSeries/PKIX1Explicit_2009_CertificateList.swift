...
@usableFromInline struct PKIX1Explicit_2009_CertificateList: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(toBeSigned: PKIX1Explicit_2009_CertificateList_toBeSigned, algorithmIdentifier: AuthenticationFramework_AlgorithmIdentifier, encrypted: ASN1BitString) {
