...
@usableFromInline struct PKIX1Implicit_2009_DistributionPoint: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(distributionPoint: PKIX1Implicit_2009_DistributionPointName?, reasons: PKIX1Implicit_2009_ReasonFlags?, cRLIssuer: PKIX1Implicit_2009_GeneralNames?) {
