...
@usableFromInline struct PKIX1Explicit_2009_RelativeDistinguishedName: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @inlinable public init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self.value = try DER.set(of: PKIX_CommonTypes_2009_SingleAttribute.self, identifier: identifier, rootNode: rootNode)
    }
