...
@usableFromInline indirect enum InformationFramework_AttributeCombination: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        switch rootNode.identifier {
            case ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific):
                self = .attribute(try InformationFramework_AttributeType(derEncoded: rootNode, withIdentifier: rootNode.identifier))
            ...
            case ASN1Identifier(tagWithNumber: 3, tagClass: .contextSpecific):
                self = .not(try InformationFramework_AttributeCombination(derEncoded: rootNode, withIdentifier: rootNode.identifier))
