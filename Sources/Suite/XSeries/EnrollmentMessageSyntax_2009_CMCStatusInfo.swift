...
@usableFromInline struct EnrollmentMessageSyntax_2009_CMCStatusInfo: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            let otherInfo: EnrollmentMessageSyntax_2009_CMCStatusInfo_otherInfo_Choice? = try EnrollmentMessageSyntax_2009_CMCStatusInfo_otherInfo_Choice(derEncoded: &nodes)
