...
@usableFromInline indirect enum PKCS_7_SignerInfo_unauthenticatedAttributes_Choice: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
