...
@usableFromInline struct Document_Profile_Descriptor_Dates_and_Times_revision_history_Set: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @usableFromInline var revisers: [Document_Profile_Descriptor_Dates_and_Times_revision_history_Set_revisers_Set]?
    @usableFromInline var version_reference: Document_Profile_Descriptor_Document_Reference?
    @usableFromInline var user_comments: Document_Profile_Descriptor_Character_Data?
    @inlinable init(revision_date_and_time: Document_Profile_Descriptor_Date_and_Time?, version_identifier: Document_Profile_Descriptor_Character_Data?, revisers: [Document_Profile_Descriptor_Dates_and_Times_revision_history_Set_revisers_Set]?, version_reference: Document_Profile_Descriptor_Document_Reference?, user_comments: Document_Profile_Descriptor_Character_Data?) {
