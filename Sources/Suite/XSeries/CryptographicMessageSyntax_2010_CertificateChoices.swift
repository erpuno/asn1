...
@usableFromInline indirect enum CryptographicMessageSyntax_2010_CertificateChoices: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
