...
public struct PKCS_5_RC5_CBC_Parameters_version_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: PKCS_5_RC5_CBC_Parameters_version_IntEnum, rhs: PKCS_5_RC5_CBC_Parameters_version_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let v1_0 = Self(rawValue: 16)
}
