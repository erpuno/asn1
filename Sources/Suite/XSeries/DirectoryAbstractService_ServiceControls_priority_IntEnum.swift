...
public struct DirectoryAbstractService_ServiceControls_priority_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: DirectoryAbstractService_ServiceControls_priority_IntEnum, rhs: DirectoryAbstractService_ServiceControls_priority_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    public static let low = Self(rawValue: 0)
