...
public struct Raster_Gr_Profile_Attributes_Ra_Gr_Coding_Attribute_jpeg_quantization_table_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: Raster_Gr_Profile_Attributes_Ra_Gr_Coding_Attribute_jpeg_quantization_table_IntEnum, rhs: Raster_Gr_Profile_Attributes_Ra_Gr_Coding_Attribute_jpeg_quantization_table_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
