...
@usableFromInline struct Style_Descriptors_Floatability_Range_backward_limit_Sequence: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            let logical_object: Style_Descriptors_Floatability_Range_backward_limit_Sequence_logical_object_Choice = try Style_Descriptors_Floatability_Range_backward_limit_Sequence_logical_object_Choice(derEncoded: &nodes)
            let layout_object: Style_Descriptors_Floatability_Range_backward_limit_Sequence_layout_object_Choice? = try Style_Descriptors_Floatability_Range_backward_limit_Sequence_layout_object_Choice(derEncoded: &nodes)
