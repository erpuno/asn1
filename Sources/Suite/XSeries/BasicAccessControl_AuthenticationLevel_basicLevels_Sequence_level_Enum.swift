...
public struct BasicAccessControl_AuthenticationLevel_basicLevels_Sequence_level_Enum: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let simple = Self(rawValue: 1)
    static let strong = Self(rawValue: 2)
}
