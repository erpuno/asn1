...
@usableFromInline struct DOR_definition_Produce_QoS: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            let qoS_level: DOR_definition_Requested_QoS_level = try DER.explicitlyTagged(&nodes, tagNumber: 0, tagClass: .contextSpecific) { node in return try DOR_definition_Requested_QoS_level(derEncoded: node) }
            ...
            return DOR_definition_Produce_QoS(qoS_level: qoS_level, usage_of_reference: usage_of_reference)
        }
    }
