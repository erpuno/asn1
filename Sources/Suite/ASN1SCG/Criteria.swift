...
public struct Criteria: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let equal = Criteria(rawValue: 0)
    static let not_equal = Criteria(rawValue: 1)
    static let like = Criteria(rawValue: 2)
}
