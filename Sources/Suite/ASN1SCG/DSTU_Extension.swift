...
@usableFromInline struct DSTU_Extension: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return DSTU_Extension(extnID: extnID, critical: critical, extnvalue: extnvalue)
        }
    }
