...
public struct KEP_TimeStampReq_version_IntEnum : DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable, Comparable {
    public static var defaultIdentifier: ASN1Identifier { .integer }
    @usableFromInline  var rawValue: Int
    @inlinable public static func < (lhs: KEP_TimeStampReq_version_IntEnum, rhs: KEP_TimeStampReq_version_IntEnum) -> Bool { lhs.rawValue < rhs.rawValue }
