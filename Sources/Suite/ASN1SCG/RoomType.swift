...
public struct RoomType: DERImplicitlyTaggable, Hashable, Sendable, RawRepresentable {
    ...
    static let group = RoomType(rawValue: 1)
    static let channel = RoomType(rawValue: 2)
    static let call = RoomType(rawValue: 3)
}
