...
@usableFromInline struct LDAP_ExtendedRequest: DERImplicitlyTaggable, Sendable {
    @inlinable static var defaultIdentifier: ASN1Identifier { .sequence }
    @usableFromInline var requestName: LDAP_OID
    @usableFromInline var requestValue: ASN1OctetString?
    @inlinable init(requestName: LDAP_OID, requestValue: ASN1OctetString?) {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            let requestName: LDAP_OID = (try DER.optionalImplicitlyTagged(&nodes, tag: ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific)))!
