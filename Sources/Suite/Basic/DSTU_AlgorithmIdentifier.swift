...
@usableFromInline struct DSTU_AlgorithmIdentifier: DERImplicitlyTaggable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return DSTU_AlgorithmIdentifier(algorithm: algorithm, parameters: parameters)
        }
    }
