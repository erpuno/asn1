...
type DescriptorsLayoutClassDescriptorBody struct {
    ObjectClassIdentifier identifiersandexpressions.ExpressionsObjectOrClassIdentifier
    GeneratorForSubordinates identifiersandexpressions.ExpressionsConstructionExpression `asn1:"optional,tag:0"`
    ContentPortions []string `asn1:"optional,tag:1"`
    Position asn1.RawValue `asn1:"optional"`
    Dimensions DescriptorsDimensionSpec `asn1:"optional,tag:4"`
    ...
    LogicalSource identifiersandexpressions.ExpressionsObjectOrClassIdentifier `asn1:"optional,tag:18"`
    ...
    Resource identifiersandexpressions.ExpressionsResourceName `asn1:"optional,tag:24"`
